# Bug_Invasion_PNP
A version of Bug_Invasion that can run on pinball or pachinko tables like the p^3/p3 pinball table.
...
To use mods, you drag the mod folder in the game folder and the mod folder must be called Bug_Invasion_PNP_Mod and one of the .tscn files must be called ModRoom.tscn
